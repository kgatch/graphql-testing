...
Feature: GraphQL testing for a travel product from https://traveller-core.dev.pelago.co/graphql?
	...
	Scenario: Query all fields of the travel product
		...
		Then the JSON response should have "data.product.productId" of type string and value "p6pye"
		Then the JSON response should have "data.product.productName" of type string and value "Yunomori Onsen and Spa"
	...
	Scenario Outline: Query fields of the travel product one by one
		...
		|productId				|data.product.productId					|string			|p6pye						|
		|productName			|data.product.productName				|string			|Yunomori Onsen and Spa		|
